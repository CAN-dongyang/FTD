...
[Serializable]
public class LessonInstanceData : InstanceData
{
	public override InstanceDataType DataType => InstanceDataType.Lesson;
	public LessonInstanceData(EntityAsset asset) : base(asset) { }

	public CharacterInstanceData professor;
	public List<CharacterInstanceData> students;
